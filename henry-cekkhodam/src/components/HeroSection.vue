...
<template>
  <div class="min-h-screen bg-[#111111] bg-[radial-gradient(#27272a_1px,transparent_1px)] [background-size:24px_24px] text-white font-sans flex flex-col items-center justify-center p-4 sm:p-6">
    
    <div class="w-full max-w-sm sm:max-w-[400px] flex flex-col">
      
      <div class="bg-zinc-900 border-2 border-zinc-700 rounded-2xl p-5 sm:p-7 w-full relative z-10">
        ...
        <div class="flex flex-col gap-3 sm:gap-4">
          <input 
            ...
            class="w-full bg-black border-2 border-zinc-700 rounded-lg p-3 text-white font-bold placeholder-zinc-500 focus:outline-none focus:border-[#a1882d] transition-all"
          />
          ...
          <div class="flex gap-2">
            <button 
              ...
              class="flex-1 cursor-pointer bg-[#a1882d] hover:bg-[#cca300] disabled:bg-zinc-700 disabled:text-zinc-500 text-black font-black py-3 px-4 rounded-lg transition-all"
            >
            ...
            <button 
              @click="reset"
              class="cursor-pointer bg-zinc-800 hover:bg-zinc-700 text-white p-3 rounded-lg border-2 border-zinc-700 hover:border-zinc-500 transition-all flex items-center justify-center"
              title="Reset"
            >
        ...
        <div class="flex justify-center gap-4 mt-6">
          <a href="https://www.instagram.com/mohan.henryk/" target="_blank" class="text-zinc-400 hover:text-[#a1882d] transition-colors" title="Instagram">
            <font-awesome-icon :icon="['fab', 'instagram']" class="text-2xl" />
          </a>
          <a href="https://github.com/HenryFtNonna" target="_blank" class="text-zinc-400 hover:text-[#a1882d] transition-colors" title="GitHub">
      ...
      <div class="self-start bg-[#a1882d] text-black font-bold text-sm py-1.5 px-5 rounded-b-lg ml-6 sm:ml-8 relative z-0 -mt-1 border-x-2 border-b-2 border-zinc-700">
        Made with 🥀 by Henry
      </div>
